...
<head>
  ...
  <meta
    ...
    content="인공지능과 블록체인이 어떻게 우리의 삶을 변화시키고 있는지 알아보세요."
  />
...
<head>
  ...
  <meta
    property="og:description"
    content="최고의 음질과 편안한 착용감을 자랑하는 CrystalSound X2 무선 이어폰. 지금 할인 중!"
  />
...
<head>
  ...
  <meta
    property="og:description"
    content="최신 기술 트렌드를 만나볼 수 있는 서울 테크 컨퍼런스에 여러분을 초대합니다."
  />
...
<head>
  ...
  <meta
    property="og:description"
    content="프론트엔드 및 백엔드 프로젝트를 포함한 김시니어의 포트폴리오를 확인해보세요."
  />
